...
export const SITE_TITLE = 'Brian G Weber Photography';
export const SITE_DESCRIPTION = 'Welcome to my blog! Check out the store for prints on a variety of products!';
